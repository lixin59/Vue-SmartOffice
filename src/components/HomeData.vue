...
export default {
    ...
    created () {
        let that = this
        var mykey = '161cff18337a40f7a811b267a8727712'
        //从onenet平台获取数据
          var api = new OneNetApi(that.apikey);
        ...
        that.$AMapLoader.load({
            ...
            var dili = geolocation.getCurrentPosition(function (status, result) {
              if (status == 'complete') {
                // console.log(result);
